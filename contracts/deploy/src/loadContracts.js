...
function getContracts(evmVersion) {
  ...
  return {
    ...
    ForeignBridgeErcToErc: require(`../../build/${buildPath}/ForeignCompoundBridgeErcToErc.json`),
    ...
    ForeignBridgeErcToNative: require(`../../build/${buildPath}/ForeignCompoundBridgeErcToNative.json`),
